...
{
    public partial class AddCostCategoryPage : CostCategoryPage
    {
        ...
        //private Row _costType
        //   => ExcelFactory.GetRow(MetaData, 4);
        protected DropdownList CostType_ddl
            => new DropdownList(FindType.Id, "ctl00_CPH_Content_ddlCcTypes");
