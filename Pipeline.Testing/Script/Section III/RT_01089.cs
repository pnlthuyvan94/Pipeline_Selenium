...
{
    public partial class C02_RT_01089 : BaseTestScript
    {
        ...
        public void C02_Jobs_ActiveJob_AddAJob()
        {
            ...
            // 5. Create a Duplicate Job
            JobPage.Instance.SelectMenu(MenuItems.JOBS).SelectItem(JobsMenu.ActiveJobs);
            JobPage.Instance.CreateJob(_jobdata, false);

            // 6. Back to list of Job and verify new item in grid view
            JobPage.Instance.SelectMenu(MenuItems.JOBS).SelectItem(JobsMenu.ActiveJobs);
