...
{
    public partial class C01_PIPE_21011 : BaseTestScript
    {
        ...
        public void SetUp()
        {
            ...
            string importOptionFile = "\\DataInputFiles\\Import\\PIPE_21011\\ImportOption\\Pipeline_Options.csv";
            ...
            else
            {
                ...
                LotPage.Instance.ImportFile("Lot Import", $@"\DataInputFiles\Import\PIPE_21011\ImportLot\{importFileDir}");
            ...
            string importBuildingPhaseFile = "\\DataInputFiles\\Import\\PIPE_21011\\ImportBuildingPhase\\Pipeline_BuildingPhases_Automation.csv";
            ...
            string importProductFile = "\\DataInputFiles\\Import\\PIPE_21011\\ImportProduct\\Pipeline_Products_Automation.csv";
        ...
        public void C01_D_Jobs_AllJobs_Import_JobQuantities_OptionSpecified()
        {
            // Step 1.1: Navigate to Jobs > All Jobs and filter job 'RT-QA_JOB_Import_Quantity' and delete if it's existing
            ExtentReportsHelper.LogInformation(null, "<font color='lavender'><b>Step 1.1: Navigate to Jobs > All Jobs and filter job 'RT-QA_JOB_Import_Quantity' and delete if it's existing.</b></font>");
            ...
            // Step 2.2: Select Option Specified button
            ExtentReportsHelper.LogInformation(null, "<font color='lavender'><b>Step 2.2: Don't need to click 'Option Specified' tab, It's default value.</b></font>");
