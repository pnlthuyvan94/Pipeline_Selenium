...
{
    class A1_Performance_Test_BOM_2 : BaseTestScript
    {
        ...
        [Test]
        [Category("Section_V")]
        public void A1_PipelineBOM_Performance_2()
        {
            HousePage.Instance.SelectMenu(MenuItems.ASSETS).SelectItem(AssetsMenu.Houses);
            //QA_HOUSE_3
            HousePage.Instance.NavigateURL("BuilderBom/HouseBom/HouseBom.aspx?hid=163");
            HouseBOMDetailPage.Instance.SelectCollection("ALL");
            HouseBOMDetailPage.Instance.GenerateHouseBOM("WC-Winding Creek");
            

            //==== House BOM 2 =======//
            HousePage.Instance.NavigateURL("BuilderBom/HouseBom/HouseBom.aspx?hid=142");
            HouseBOMDetailPage.Instance.SelectCollection("ALL");
            HouseBOMDetailPage.Instance.GenerateHouseBOM("WC-Winding Creek");

            //==== House BOM 3 =======//
            HousePage.Instance.NavigateURL("BuilderBom/HouseBom/HouseBom.aspx?hid=166");
            HouseBOMDetailPage.Instance.SelectCollection("ALL");
            HouseBOMDetailPage.Instance.GenerateHouseBOM("WC-Winding Creek");
