...
{
    class TestData_PIPE_34161 : BaseTestScript
    {
        ...
        [Test]
        public void SetUpTestData_A04_I_Assets_DetailPage_Houses_HouseBOMPage_Zero_Quantities_Showing_on_house_BOM()
        {
            ...
            ManufacturerPage.Instance.SelectMenu(MenuItems.ESTIMATING).SelectItem(EstimatingMenu.Manufacturers);
            ManufacturerData manuData5 = new ManufacturerData()
            {
                Name = "QA_RT_Manufacturer5_Automation"
            };

            ManufacturerPage.Instance.FilterItemInGrid("Name", GridFilterOperator.Contains, manuData5.Name);
            if (ManufacturerPage.Instance.IsItemInGrid("Name", manuData5.Name) is false)
            {
                // If Manu doesn't exist then create a new one
                ManufacturerPage.Instance.CreateNewManufacturer(manuData5);
            }
            ...
            StylePage.Instance.SelectMenu(MenuItems.ESTIMATING).SelectItem(EstimatingMenu.Styles);
            StyleData styleData5 = new StyleData()
            {
                Name = "QA_RT_Style5_Automation",
                Manufacturer = manuData5.Name
            };
            StylePage.Instance.FilterItemInGrid("Name", GridFilterOperator.Contains, styleData5.Name);
            if (StylePage.Instance.IsItemInGrid("Name", styleData5.Name) is false)
            {
                // If Style doesn't exist then create a new one
                StylePage.Instance.CreateNewStyle(styleData5);
            }
            ...
            string importFile = "\\DataInputFiles\\Import\\PIPE_34161\\Pipeline_Categories.csv";
            ...
            importFile = "\\DataInputFiles\\Import\\PIPE_34161\\Pipeline_ProductUses.csv";
            ...
            importFile = "\\DataInputFiles\\Import\\PIPE_34161\\Pipeline_BuildingPhases.csv";
            ...
            importFile = "\\DataInputFiles\\Import\\PIPE_34161\\Pipeline_Products.csv";
